...
public class BankUtils {
    ...
    private final static int[] bankBin = {
            ...
            623251, 628351, 627066, 627066, 627067, 627068, 627069, 412962, 412963, 415752, 415753, 622535, 622536, 622538, 622539, 622983, 998800, 955880};
    // "发卡行.卡种名称",  
    private static final String[] bankName = {
            ...
            "玉溪市商业银行·红塔卡", "平安银行", "平安银行", "平安银行", "平安银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "深圳发展银行", "中国工商银行"};
    ...
    //获取银行卡银行代码
    public static String getCode(String cardnumber) {

        String charBin = cardnumber.substring(0, 6);
        int bin = 0, index = 0;
        bin = Integer.valueOf(charBin);
        index = binarySearch(bankBin, bin);
        if (index == -1 || index > bankCode.length) {
            return null;
        }
